...
var globalAssetSources = (_assetSources.default ? _assetSources.default : _assetSource.default).map(source => _objectSpread(_objectSpread({}, source), {}, {
  component: (0, _withDocument.default)(source.component)
}));

function ImageInputField(props) {
  var onChange = props.onChange,
      restProps = _objectWithoutProperties(props, ["onChange"]);

  var handleChange = (0, _react.useCallback)(ev => {
...
class ImageInput extends _react.default.PureComponent {
  constructor(props) {
    ...
    if (Array.isArray(sourcesFromType) && sourcesFromType.length > 0) {
      this.assetSources = sourcesFromType.map(source => _objectSpread(_objectSpread({}, source), {}, {
        component: (0, _withDocument.default)(source.component)
      }));
  ...
  renderField(field) {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      key: field.name
    }, /*#__PURE__*/_react.default.createElement(ImageInputField, {
      field: field,
      value: fieldValue,
      type: field.type,
